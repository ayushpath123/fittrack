...
export default function WeightStep({ direction, value, onChange, onBack, onNext }: WeightStepProps) {
  return (
    <StepContainer direction={direction}>
      <p className="mb-1.5 text-[11px] font-medium uppercase tracking-[0.1em] text-white/30">Step 1 of 3</p>
      <h2
        className="mb-6 text-[26px] font-bold tracking-[-0.5px] text-white"
        style={{ fontFamily: "var(--font-display), system-ui, sans-serif" }}
      >
        What&rsquo;s your weight?
      </h2>

      <SliderInput value={value} min={30} max={150} unit="kg" onChange={onChange} />
