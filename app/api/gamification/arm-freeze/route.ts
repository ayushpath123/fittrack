...
import { armFreezeMutation, getRequestAuditMeta, GamificationHttpError } from "@/lib/gamification-server";
...
export async function POST(req: Request) {
  ...
  try {
    const summary = await armFreezeMutation(auth.userId, getRequestAuditMeta(req));
