...
import { buyXpBoostMutation, getRequestAuditMeta, GamificationHttpError } from "@/lib/gamification-server";
...
export async function POST(req: Request) {
  ...
  try {
    const summary = await buyXpBoostMutation(auth.userId, getRequestAuditMeta(req));
