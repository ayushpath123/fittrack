...
import { buyFreezeMutation, getRequestAuditMeta, GamificationHttpError } from "@/lib/gamification-server";
...
export async function POST(req: Request) {
  ...
  try {
    const summary = await buyFreezeMutation(auth.userId, getRequestAuditMeta(req));
